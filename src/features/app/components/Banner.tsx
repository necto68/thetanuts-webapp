...
import { BannerContainer, BannerText, BannerLink, IconWrapper } from "./App.styles";

export const Banner = () => (
  <BannerContainer>
    <BannerText>
      <IconWrapper><Annoucement /></IconWrapper> You are accessing Thetanuts Finance's legacy v2 products.
